...
async function startAdrian() {
    ...
    const conn = connConnect({
        ...
        browser: ['ʀᴇʏᴢ ʜᴏsᴛɪɴɢ','Safari','1.0.0'],
   ...
   // anticall auto block
    ...
    conn.ev.on('messages.upsert', async chatUpdate => {
        ...
        if (mek.key.id.startsWith('ʀᴇʏᴢ ʜᴏsᴛɪɴɢ')) return
				...
				conn.sendMessage(res.id, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            sourceUrl: "https://instagram.com/reyzoffc",
                            mediaType: 1,
